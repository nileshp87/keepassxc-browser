...
kpxcBanner.create = async function(credentials = {}) {
    ...
    const ignoreButton = kpxcUI.createElement('button', 'kpxc-button kpxc-white-button', { 'id': 'kpxc-banner-btn-ignore' }, tr('popupButtonIgnore'));
    ...
    dismissButton.addEventListener('click', function(e) {
        ...
        if (dialog) {
            ...
            $('#kpxc-banner-btn-ignore').hidden = false;
            document.body.removeChild(dialog);
        } else {
            kpxcBanner.destroy();
        }
    ...
    bannerButtons.appendMultiple(newButton, updateButton, ignoreButton, dismissButton);
    banner.appendMultiple(bannerInfo, bannerButtons);
    document.body.appendChild(banner);
};

kpxcBanner.saveNewCredentials = function(credentials = {}) {
    browser.runtime.sendMessage({
...
kpxcBanner.createCredentialDialog = async function() {
    ...
    $('#kpxc-banner-btn-ignore').hidden = true;
